	...
	<body class="loggedin">
		...
		<div class="content">
			...
			<div>
				...
				<div class="row">
				<?php
            function createSection($icon, $location, $title) {
              echo '
            ...
            createSection('address-card', 'addsupplier.php', 'Add/View Supplier');
            createSection('handshake', 'addcustomer.php', 'Add New Customer');
            createSection('shopping-bag', 'addmedicine.php', 'Add New Medicine');
