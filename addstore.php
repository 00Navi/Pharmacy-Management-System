...
if (isset($_POST['STORE_NAME'])) {
	...
	if ($stmt = $con->prepare($sql)) {
        $stmt->bind_param('ssssss', $_POST['STORE_NAME'],$_POST['STORE_ADDRESS'],$_POST['STORE_CITY'],$_POST['STORE_STATE'],$_POST['STORE_EMAIL'],$_POST['STORE_PHNO'] );
        $result = $stmt->execute();
        if ($result) {
	...
	<body>
		...
		<div class="login">
			...
			<form action="addstore.php" method="post">
                ...
                <input type="text" name="STORE_NAME" placeholder="STORE_NAME" id="STORE_NAME" required>
