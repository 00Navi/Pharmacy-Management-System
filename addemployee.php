...
if (isset($_POST['EMPLOYEE_NAME'])) {
	...
	if ($stmt = $con->prepare($sql)) {
        $stmt->bind_param('ssss', $_POST['EMPLOYEE_NAME'],$_POST['STORE_ID'],$_POST['EMPLOYEE_EMAIL'],$_POST['EMPLOYEE_PHNO'] );
        $result = $stmt->execute();
        if ($result) {
	...
	<body>
		...
		<div class="login">
			...
			<form action="addemployee.php" method="post">
                ...
                <label for="STORE_ID">Name</label>
                <input type="NUMBER" name="STORE_ID" placeholder="STORE_ID" id="STORE_ID" required>
